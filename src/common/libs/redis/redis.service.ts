...
import {
  RedisService as LiaoliaoRedisService,
  DEFAULT_REDIS,
...
export class RedisService {
  ...
  constructor(private readonly liaoliaoRedisService: LiaoliaoRedisService) {
    this.client = this.liaoliaoRedisService.getOrThrow();
  }
